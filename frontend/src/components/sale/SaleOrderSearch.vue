  ...
  <div class="search-bar">
    <div class="search-inputs">
      <div class="form-group">
        <label for="search-transaction-no">交易流水号</label>
        <div class="input-with-checkbox">
          <input 
            type="text" 
            id="search-transaction-no" 
            v-model="searchParams.transaction_no" 
            placeholder="搜索交易流水号"
          />
          <div class="checkbox-wrapper">
            <input 
              type="checkbox" 
              id="exact-transaction-no" 
              v-model="searchParams.exact_transaction_no"
            />
            <label for="exact-transaction-no">精确匹配</label>
          </div>
        </div>
      </div>
      
      <div class="form-group">
        <label for="search-payment-method">支付方式</label>
        <select id="search-payment-method" v-model="searchParams.payment_method">
      ...
      <div class="form-group">
        ...
        <select id="search-sort-by" v-model="searchParams.sort_by">
          ...
          <option value="transaction_no">交易流水号</option>
